...
;33 interrupt 21h 
	dw unhandled_int                     ; Dos int21h functions
	dw sys_code
	db 0
	db sys_interrupt
	dw 0
...
;98 interrupt 62h <- IRQ 2
	dw unhandled_int		   ; reserved (8259B)
	dw sys_code
	db 0
	db sys_interrupt
	dw 0
...
;102 interrupt 66h <- IRQ 6
	dw unhandled_int			    ; primary IDE drives (floppy drive)
	dw sys_code
	db 0
	db sys_interrupt
	dw 0
...
;103 interrupt 67h <- IRQ 7
	dw unhandled_int		    ; secondary IDE drives (hdd?)
	dw sys_code
	db 0
	db sys_interrupt
	dw 0
